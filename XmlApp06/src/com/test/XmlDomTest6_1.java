...
//				System.out.println(rootElement.getNodeName());
				...
				Node itemNode = rootElement.getElementsByTagName("item").item(0);
				Element itemElement = (Element)itemNode;
				

//				System.out.printf(" %s", itemElement.getChildNodes().item(0).getNodeValue());
				System.out.printf("%s %n%n", getText(itemElement, "title"));
				
				// 기상전망 추출하기 
				System.out.printf("%s %n%n", getText(itemElement, "wf").replaceAll("<br />", "\n"));
